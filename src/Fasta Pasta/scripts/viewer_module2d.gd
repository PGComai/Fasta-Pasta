...
func _ready():
	...
	control.make_line2d.connect(_on_control_make_line2d)
...
func _on_control_make_line2d(arr: PackedVector2Array, colors: PackedColorArray, length: int, id: String, idx: int, map: bool):
